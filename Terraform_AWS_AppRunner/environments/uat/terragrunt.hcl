...
inputs = {
  ...
  #----------------------- S3 --------------------------------------------------------
  create_project_name-portal-uat = true
  project_name-portal-bucket-name         = "project_name-portal-uat"
...
react_app_api_key_location = "/project_name/portal/react_app_api_key_location"
  ...
  image_tag_be                     = "v0.1.0-c00848a"
  auto_deployments_enabled_value   = false
